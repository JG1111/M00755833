...
tk.Button(frame, text="Pokemon Encounter X", command=pokemoncatcherx()).grid(column=0, row=1)
tk.Button(frame, text="Pokedex", command=pokemon()).grid(column=0, row=2)
tk.Button(frame, text="Quit", command=root.destroy).grid(column=0, row=3)
