...
def explosion(colour):
    ...
    for x in range(27):
        ...
        count +=1
        if left >= 4:
            leds[29-fadeleft] = (0,0,0)
            leds[30+faderight] = (0,0,0)
            leds[88-fadeleft] = (0,0,0)
...
def capture():
    pokeballshake()
    capturechance = random.randint(0,1)
    if capturechance == 0:
